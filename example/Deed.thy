...
(*    
        ...
        apply(drule star_case; auto)
              ...
              oops
  *)            
              (* probably because the gas calculation for CALL is too long,
                 a simple symbolic execution no longer works. *)
              (* apply(simp) *)
oops
...
text {* It takes 30 hours to compile this proof on my machine.  Ten minutes
