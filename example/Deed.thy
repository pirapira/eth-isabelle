       ...
       apply(split strict_if_split; auto)
        ...
        apply(split strict_if_split; auto)
         ...
         apply(split strict_if_split; auto)
           ...
           apply(split strict_if_split; auto)
            ...
            apply(split strict_if_split; auto)
             ...
             apply(case_tac nata; auto)
              apply(split strict_if_split; auto)
             apply(split strict_if_split; auto)
              apply(case_tac nata; auto simp add: postcondition_pack_def deed_inv.simps deed_postcondition_def)
             apply(case_tac nata; auto)
             apply(case_tac nata; auto)
             apply(case_tac nata; auto)
             apply(case_tac nata; auto)
          ...
          apply(case_tac a; simp add: postcondition_pack_def deed_inv.simps deed_postcondition_def)
          apply(case_tac act; simp)
          apply(drule star_case; simp)
          apply(clarify)
          apply(auto)
         apply(case_tac nata; auto)
         ...
         apply(simp)
          apply(clarify)
          apply(case_tac a; auto simp add: postcondition_pack_def deed_inv.simps deed_postcondition_def)
         apply(case_tac act; simp add: postcondition_pack_def deed_inv.simps deed_postcondition_def)
         apply(case_tac a; simp)
         apply(drule star_case; simp)
         apply(clarify)
         apply(auto)
