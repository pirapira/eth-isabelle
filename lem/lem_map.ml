...
let instance_Basic_classes_Eq_Map_map_dict dict_Basic_classes_Eq_k dict_Basic_classes_Eq_v:(('k,'v)Pmap.map)eq_class= ({
...
let instance_Map_MapKeyType_var_dict dict_Basic_classes_SetType_a:'a mapKeyType_class= ({

  mapKeyCompare_method = 
...
let fromList dict_Map_MapKeyType_k l:('k,'v)Pmap.map=  (List.fold_left (fun m (k,v) -> Pmap.add k v m) (Pmap.empty  
...
(*let all P m:bool=  (forall k v. (P k v && ((Instance_Basic_classes_Eq_Maybe_maybe.=) (lookup k m) (Just v))))*)
...
(* instance of SetType *)
let map_setElemCompare dict_Basic_classes_SetType_a dict_Basic_classes_SetType_b dict_Basic_classes_SetType_c dict_Basic_classes_SetType_d dict_Map_MapKeyType_b dict_Map_MapKeyType_d cmp x y:'e=  
 (cmp ((Pmap.bindings (pairCompare  
  dict_Basic_classes_SetType_d.setElemCompare_method  dict_Basic_classes_SetType_c.setElemCompare_method) x)) ((Pmap.bindings (pairCompare  
  dict_Basic_classes_SetType_b.setElemCompare_method  dict_Basic_classes_SetType_a.setElemCompare_method) y)))

let instance_Basic_classes_SetType_Map_map_dict dict_Basic_classes_SetType_a dict_Basic_classes_SetType_b dict_Map_MapKeyType_a:(('a,'b)Pmap.map)setType_class= ({

  setElemCompare_method = (fun x y->map_setElemCompare 
  dict_Basic_classes_SetType_b dict_Basic_classes_SetType_a dict_Basic_classes_SetType_b dict_Basic_classes_SetType_a dict_Map_MapKeyType_a dict_Map_MapKeyType_a Pset.compare x y)})
