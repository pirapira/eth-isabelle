...
lemma word_convert_compare : "x \<ge> 0 \<Longrightarrow> uint (word_of_int x) \<le> x"
...
"vctx_memory_usage v1 \<ge> 0 \<Longrightarrow>
 vctx_recipient v1 c = ucast x21a \<Longrightarrow>
 vctx_stack v1 = x21 # x21a # x21b # x21c # x21d # x21e # x21f # x22f \<Longrightarrow>
 Ccallgas x21 x21a x21b (\<not> vctx_account_existence v1 (ucast x21a))
                (vctx_gas v1) net
